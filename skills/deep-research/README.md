...
## 📄 Output Formats
Standard Synthesis Report: Executive summary, thematic analyses with inline citations ([1](https://github.com/Zivatron/Agent-Zivatron/blob/main/skills/deep-research/SKILL.md)), discrepancy tables, and a verified source registry.
